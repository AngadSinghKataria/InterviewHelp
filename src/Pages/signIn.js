      ...
      return (
        <div style={{display: 'flex', flexDirection: 'column',justifyContent: 'center',alignContent:'center',alignItems: 'center', width: '50%', minHeight: '100%', backgroundColor: '#E2E2E2', borderBottomRightRadius: '25px',borderTopRightRadius: '25px'}}> 
          ...
          <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', width: '80%'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center' ,borderRadius: '25px' ,width: '60%',padding: '3%', marginTop: '30px', backgroundColor: '#BC9DE0', textAlign: 'center', fontWeight: '500', fontSize: '16px'}} onClick={()=>{navigate('/dashboard')}}>Sign Up Now</div>
          </div>
        </div>
      )
    }
